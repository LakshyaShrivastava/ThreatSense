...
public class RawNetworkLog {
    ...
    // These fields directly match the JSON produced by PlainKafkaProducer
    ...
    // (Assuming you previously added these to your producer's NetworkLog)
    ...
    public RawNetworkLog(String srcIP, String destIP, long port, String protocol, long bytes, Instant timestamp) {
        this.srcIP = srcIP;
        this.destIP = destIP;
        this.port = port;
